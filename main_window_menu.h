...
#define MWM_TABOO_ALGORITHM 0x105
#define MWM_COMPUTE_SOLUTION_COST 0x106
#define MWM_PRESENT_SOLUTION_ACCEPTABILITY 0x107
#define MWM_PRESENT_SOLUTION_COST 0x108
